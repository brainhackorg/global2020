...
url = "https://api.github.com/repos/ohbm/hackathon2020/issues?per_page=100"
    ...
    if issue['state'] == 'open':
        for label in issue['labels']:
            if label['name'] == value:
                ...
                labels = {'labels': []}
                for label in issue['labels']:
                    # TODO: Implement some conditionals to filter out irrelevant labels that we created.
                ...
                # TODO: Implement some REGEX to grab relevant terms such as Project leads, etc.
...
for project in projects.items():
    with open(str('global2020/content/project/project_' + str(project[1]['issue_number']) + '.md'), 'w') as json_file:
